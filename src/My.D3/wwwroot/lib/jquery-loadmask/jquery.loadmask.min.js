 ...
 */
(function (a) {
    a.fn.mask = function (c, opacity, b) {
        a(this).each(function () {
            if (b !== undefined && b > 0) {
                var d = a(this);
                d.data("_mask_timeout", setTimeout(function () {
                    a.maskElement(d, c, opacity)
                },
                    b))
            } else {
                a.maskElement(a(this), c, opacity)
            }
        })
    };
    ...
    a.maskElement = function (d, c, opacity) {
        ...
        if (opacity) {
            e = a('<div class="loadmask" style="opacity:' + opacity + '"></div>');
        }
